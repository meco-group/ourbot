#ifndef VELOCITYCOMMANDINTERFACE_TYPES_HPP
#define VELOCITYCOMMANDINTERFACE_TYPES_HPP
 ...
 */
struct VelocityCommandInterfaceData
{
    /** Contains a sequence of doubles. */
    std::vector<double> samples;
};

#endif // VELOCITYCOMMANDINTERFACE_TYPES_HPP
