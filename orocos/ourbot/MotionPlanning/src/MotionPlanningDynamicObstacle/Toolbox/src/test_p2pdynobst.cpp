...
int main()
{
    ...
    p2pdynobst::Holonomic* vehicle = new p2pdynobst::Holonomic();
    ...
    p2pdynobst::Point2Point p2p(vehicle, update_time, sample_time, horizon_time, trajectory_length);
    ...
    // obstacles
    vector<p2pdynobst::obstacle_t> obstacles(p2p.n_obs);
    double width = 3.0;
    double height = 0.2;
    double radius = 0.001;
