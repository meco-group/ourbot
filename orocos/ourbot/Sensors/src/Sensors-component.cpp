...
bool Sensors::configureHook(){
  ...
  _cal_lidar_x_port.setDataSample(example_lidar);
  _cal_lidar_y_port.setDataSample(example_lidar);
  std::vector<double> example_ir(_ir_data_length, 0.0);
  _cal_ir_x_port.setDataSample(example_ir);
  _cal_ir_y_port.setDataSample(example_ir);
...
void Sensors::updateHook(){
  std::vector<double> example_lidar(_lidar_data_length, 0.0);
  _cal_lidar_x_port.write(example_lidar);
  _cal_lidar_y_port.write(example_lidar);
  std::vector<double> example_ir(_ir_data_length, 0.0);
  _cal_ir_x_port.write(example_ir);
  _cal_ir_y_port.write(example_ir);
  std::vector<double> example(3,0.0);
