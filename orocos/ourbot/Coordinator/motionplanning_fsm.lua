...
function set_motionplanner(mp, load_obstacles_fun)
  ...
  add_static_obstacle = motionplanning:getOperation('addStaticObstacle')
  add_dynamic_obstacle = motionplanning:getOperation('addDynamicObstacle')
  add_peer_obstacle = motionplanning:getOperation('addPeerObstacle')
