...
local pathgenerator = tc:getPeer('pathgenerator'..tostring(index))
...
local pathgeneratorInRunTimeError = pathgenerator:getOperation("inRunTimeError")
  ...
  run = rfsm.state{
    ...
    doo = function(fsm)
      ...
      while true do
        ...
        if pathgeneratorInRunTimeError() then
          rtt.logl("Error","RunTimeError in pathgenerator")
          rfsm.send_events(fsm,'e_failed')
          return
        end
