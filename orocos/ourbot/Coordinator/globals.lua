...
function init_globals()
  ...
  get_circular_obstacles = eaglebridge:getOperation('getCircularObstacles')
  get_rectangular_obstacles = eaglebridge:getOperation('getRectangularObstacles')
  get_robot_pose = eaglebridge:getOperation('getRobotPose')
  get_robot_timestamp = eaglebridge:getOperation('getRobotTimestamp')
  -- ports
